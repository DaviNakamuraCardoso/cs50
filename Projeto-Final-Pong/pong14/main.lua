...
--//___________________________ Buttons ____________________________________\\--
    ...
    button_pvp = Button(VIRTUAL_WIDTH / 2 - 100, VIRTUAL_HEIGHT / 3, 70, 40, 'Player 1\nvs\nPlayer 2', 'player_vs_player', 'start')

    -- Player vs AI button
    button_pva = Button(VIRTUAL_WIDTH / 2 + 30, VIRTUAL_HEIGHT  / 3, 70, 40, 'Player\nvs\nA.I.', 'player_vs_ai', 'start')

    -- Play button
    button_play = Button(VIRTUAL_WIDTH / 2 - 50, VIRTUAL_HEIGHT / 4, 100, 20, 'Play Game',
'none', 'mode_menu')
    button_play.font_size = 15
...
function love.update(dt)
    ...
    --\\________________________________________________________________//--
    if game_state ~= 'pause'  and game_state ~= 'mode_menu' and game_state ~= 'menu' then
...
function love.draw()
    ...
    if game_state ~= 'menu' and game_state ~= 'mode_menu' then
