...
function Player:init(map)
    ...
    -- Messages
    self.messageScore = Message(0, VIRTUAL_HEIGHT / 2, 'fonts/four.ttf', 14, colors['white'])
    self.messageBoxes = Message(0, VIRTUAL_HEIGHT / 2 + 30, 'fonts/four.ttf', 14,
    colors['white'])
...
function Player:render()
    ...
    if self.map.newLevel then
        ...
        -- Messages
        self.messageScore:prettyShow(self.score, self.sounds['score'],'SCORE:', 2)
        self.messageBoxes:prettyShow(self.coins, self.sounds['box'],'BOXES: ', 1)
    end
end
