...
--//___________________________ Buttons ____________________________________\\--
    ...
    button_pvp = Button(X_CENTER - 100, Y_CENTER, 80, 48)
    button_pvp.font_y = 2
    button_pvp.font_size = 12

    -- Player vs AI button
    button_pva = Button(X_CENTER + 30, Y_CENTER, 80, 48)
    button_pva.font_y = 2
    button_pva.font_size = 12

    -- Play button
    button_play = Button(X_CENTER - 50, Y_CENTER, 100, 20)

    --//______________________ Settings button __________________________\\--
    button_settings = Button(X_CENTER - 50, Y_CENTER + 30, 100,
    20)

    --\\_________________________________________________________________//--
    -- Credit button
    button_credits = Button(X_CENTER - 50, Y_CENTER + 60, 100, 20)
    button_back_to_menu = Button(VIRTUAL_WIDTH - 70, 20, 50, 20)
...
--\\________________________________________________________________________//--
    ...
    message_2 = Message(0, 40, 8, pixeled)
...
function love.update(dt)
    ...
    elseif game_state ~= 'play' and game_state ~= 'serve' then
        button_back_to_menu:update('menu', 'nogame')
    end
    --\\________________________________________________________________//--
