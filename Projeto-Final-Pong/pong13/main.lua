...
function love.load()
    ...
    button_1 = Button(VIRTUAL_WIDTH / 2 - 100, VIRTUAL_HEIGHT / 3, 70, 40, 'Player 1\nvs\nPlayer 2', 'player_vs_player')
    button_2 = Button(VIRTUAL_WIDTH / 2 + 30, VIRTUAL_HEIGHT  / 3, 70, 40, 'Player\nvs\nA.I.', 'player_vs_ai')
...
function love.update(dt)
    ...
    --\\________________________________________________________________//--
    if game_state ~= 'pause'  and game_state ~= 'menu' then
