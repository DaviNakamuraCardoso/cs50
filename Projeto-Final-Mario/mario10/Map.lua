...
function Map:init()
    ...
    for f=1, 7 do
        if f == 1 then
            self:setTile(self.mapWidth - 7, self.mapHeight / 2 - f, FLAG_BOTTOM)
        elseif f == 7 then
            self:setTile(self.mapWidth - 7, self.mapHeight / 2 - f, FLAG_TOP)
        else
            self:setTile(self.mapWidth - 7, self.mapHeight / 2 - f, FLAG_MIDDLE)
        end
    end
