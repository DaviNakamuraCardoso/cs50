...
function Map:enemyKilling()
    for i=1, self.numberOfEnemies do
        if self.player.x + self.player.width >= self.enemies[i].x and self.enemies[i].x +     self.enemies[i].width > self.player.x and self.player.y + self.player.height >   self.enemies[i].y then
